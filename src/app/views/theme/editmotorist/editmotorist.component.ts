...
export class EditmotoristComponent implements OnInit {
  ...
  updatemotorist(form : any){
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/motorist/update/';      
  ...
  getMotorist(id : any): void {    
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/motorist/motorist/';      
