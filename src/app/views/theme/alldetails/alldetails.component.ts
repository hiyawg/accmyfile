...
PedastrianUpdate(pedastrianid:any){
  ...
  deletemotorist(id:any): void {
    ...
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/motorist/delete';   
...
//         })
  ...
  deletepiv(id:any): void {
    console.log("*******Id  to delete" + id)
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/personinvehicle/delete';   
     this.http.delete(rooturl + '/' + id).toPromise()
      window.location.reload()
  ...
  deleteped(id:any): void {
    console.log("*******Id  to delete" + id)
    const rooturl = 'https://traficaccidentreport.herokuapp.com//trafficaccidentanalysis/pedastrian/delete/';   
     this.http.delete(rooturl + '/' + id).toPromise()
      window.location.reload()
  ...
  deletevehicle(id:any): void {
    console.log("*******Id  to delete" + id)
    const rooturl = 'https://traficaccidentreport.herokuapp.com//trafficaccidentsanalysis/vehicle/delete/';   
     this.http.delete(rooturl + '/' + id).toPromise()
      window.location.reload()
