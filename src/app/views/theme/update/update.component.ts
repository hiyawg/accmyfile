...
export class UpdateComponent implements OnInit {
  ...
  updateaccident(form : any){
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/accident/update/';      
  ...
  getAccident(): void {    
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/accident/accident/';      
