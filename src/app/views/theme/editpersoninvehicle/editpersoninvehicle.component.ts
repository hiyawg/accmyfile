...
export class EditpersoninvehicleComponent implements OnInit {
  ...
  updatepersoninvehicle(form : any){
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/personinvehicle/update/';      
  ...
  getPersoninvehicle(id : any): void {    
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/personinvehicle/personinvehicle/';      
