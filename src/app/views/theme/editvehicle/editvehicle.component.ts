...
export class EditvehicleComponent implements OnInit {
  ...
  updatevehicle(form : any){
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentsanalysis/vehicle/update/';      
  ...
  getVehicle(id : any): void {    
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentsanalysis/vehicle/vehicles/';      
