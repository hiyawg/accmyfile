...
export class EditpedastrianComponent implements OnInit {
  ...
  updatepedastrian(form : any){
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/pedastrian/update/';      
  ...
  getPedastrian(id : any): void {    
    const rooturl = 'https://traficaccidentreport.herokuapp.com/trafficaccidentanalysis/pedastrian/pedastrian/';      
